 ...
 */
public class mainUIT extends JFrame {
	/**
	 * 
	 */
	...
	private void usingRubineMouseClicked(MouseEvent e) {
		...
		feedbackText.setText("Recognition:\t[Basic Stroke: Hengzhe] is written\n");
		feedbackText.append("Feedback:\t Looks Good, correct direction\n\n");
		
		feedbackText.append("Recognition:\t[Compound Stroke: She] is written\n");
		feedbackText.append("Feedback:\t Looks Good, correct direction\n\n");
		
		feedbackText.append("Recognition:\t[Radical: Cover] is written\n");
		feedbackText.append("Feedback:\t Looks Good\n");
		feedbackText.append("Feedback:\t !!Warning!! [Shu] should be before [Hengzhe]\n\n");
