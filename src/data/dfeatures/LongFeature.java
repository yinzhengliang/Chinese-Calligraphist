...
private static String output_folder = Constant.MODEL_DIR + "Long/" + "Long.txt";
...
//	            System.out.println("Directory: " + file.getAbsolutePath());
	...
	public static void LongFeatures() {
		Long longRecognizer = new Long();
	...
	public static void write(Map<String, Map<String, Double>> data) {
		try {
			...
			for (String name : featureNames) {
				writer.write(name + "\t");
				for (String s_name : featureNames) {
					writer.write(String.format("%.7f,",data.get(s_name).get(name)));
				}
				writer.write(";");
				writer.newLine();
			}
